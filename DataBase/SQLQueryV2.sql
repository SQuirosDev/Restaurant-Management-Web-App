...
>>>>>>> 6f8e9bd8cd3cb50b8473ec1a6c2983740b84d065
-- Tabla Usuarios
...
-- Procedimiento para iniciar sesi�n (MODIFICADO)
=======
GO
...
-- Procedimiento para insertar plato en el men�
=======
GO
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            RETURN -1; -- Nombre de plato no puede estar vac�o
        END
...
-- Procedimiento para obtener men� (MODIFICADO)
...
INSERT INTO Menu (nombre_plato, descripcion, precio)
VALUES 
('Paella Valenciana', 'Arroz tradicional espa�ol con mariscos y pollo', 25.50),
('Filete Mignon', 'Corte de res premium con salsa de champi�ones', 35.00),
('Salm�n a la Parrilla', 'Salm�n fresco con pure de papas', 28.75),
('Ensalada C�sar', 'Ensalada cl�sica con aderezo C�sar y pollo', 15.00),
...
VALUES 
(1, 5, 'Paella Valenciana, Ensalada C�sar', '25.50, 15.00', 40.50, GETDATE()),
(2, 8, 'Filete Mignon, Salm�n a la Parrilla', '35.00, 28.75', 63.75, GETDATE());

-- Insert sample Feedback
INSERT INTO Feedback (id_usuario, comentario, calificacion)
VALUES 
(1, 'Excelente servicio y comida deliciosa!', 5),
(3, 'La comida estuvo bien, pero un poco lenta la atenci�n', 3),
(4, 'Ambiente muy agradable, volver� pronto', 4);
...
(1, 4), -- Ensalada C�sar in first invoice
(2, 2), -- Filete Mignon in second invoice
(2, 3); -- Salm�n a la Parrilla in second invoice
=======
GO
